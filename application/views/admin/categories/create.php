            ...
            <ol class="breadcrumb mb-4">
              ...
              <div class="row">
                <div class="col-xl-6 col-md-8">
                  <?= form_open("admin/category_create", array("id"=>'main'))?>
                    <div class="form-group">
                      <label for="Pengguna">Judul kategori</label>
                      <input type="text" name="nama" class="form-control" id="Pengguna" aria-describedby="emailHelp" value="<?=set_value('username')?>">
                      <?= form_error('username'); ?>
                      <div class="col-sm-5 messages"></div>
                    </div>
                    <div class="form-group">
                      <label for="Lengkap">Slug</label>
                      <input type="text" name="slug" class="form-control" value="<?=set_value('full_name')?>" id="Lengkap" aria-describedby="emailHelp" >
