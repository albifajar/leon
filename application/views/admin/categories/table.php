                ...
                <div class="container-fluid">
                  ...
                  <div class="card mb-4">
                      <div class="card-header">
                        <div class="row">
                        <div class="col-6"><i class="fas fa-table mr-1"></i></div>
                        <div class="col-6 text-right"><a class="btn btn-primary" href="<?=base_url()?>admin/category_create">Tambah</a></div>
                      </div>
                      </div>
                      <div class="card-body">
                          <div class="container-fluid">
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <button class="dropdown-item" onclick="delConfirm('<?=base_url()?>admin/category_delete/<?=$row['id']?>')"><i class="fas fa-trash-alt"></i> Hapus</button>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
